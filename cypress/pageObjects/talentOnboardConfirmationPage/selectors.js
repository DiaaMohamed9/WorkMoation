module.exports = {
    ...
    businessAssignmen: "//p[contains(text(),'Business assignmen')]/following::p[1]",
    ...
    reimburseExpenses: "//p[contains(text(),'reimburse expenses')]/following::p[1]",
    ...
    titleOfSignatory: "//p[contains(text(),'Title of signatory')]/following::p[1]",
    emailOfDirectManager: "//p[contains(text(),'Email of direct manager')]/following::p[1]",
    paidTimeOff: "//p[contains(text(),'PTO')]/following::p[1]",
    probationaryPeriod: "//p[contains(text(),'probationary period')]/following::p[1]",
