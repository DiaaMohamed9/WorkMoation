...
class talentOnbaord {
    chooseCountry(çountry='Germany') {
        return cy.xpath(selectors.chooseCountryOption.replace('CountryName',çountry))
    }
    countryList() {
    ...
    generateTalentData(countriesNames){
        ...
        return {
            ...
            workAddress:workFromHomeOption?faker.address.streetAddress():undefined,
            ...
            probationPeriod:probationPeriodOption? faker.datatype.number({ 'min': 0,'max': 6}):undefined ,
            probationPeriodEnablement:probationPeriodOption ,
            ...
            totalYearlyBonus:annualBonusEnablementOption?faker.datatype.number({ 'min':5000,'max': 9000}):undefined,
            bonusPayoutFrequencySelect:annualBonusEnablementOption?'yearly':undefined,
            bonusAnythingElse:annualBonusEnablementOption?faker.random.words():undefined,
