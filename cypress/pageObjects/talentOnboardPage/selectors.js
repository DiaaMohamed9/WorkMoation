module.exports = {
    chooseCountryOption: "//*[contains(@id,'select') and contains(@id,'option') and text()='CountryName']",
    ...
    beginOnboardingButton: '//*[@data-cy="product-selection-begin-onboarding-btn"]',
    employmentAgreementTitle: '//*[@data-cy="steps-employment-agreement-details-title"]',
    ...
    businessAssignmentInput: '//*[@data-cy="steps-business-assignment-context-textarea"]',
    jobDescriptionUploadInput: '//*[@data-cy="steps-upload-job-description-upload-input"]',
    ...
    eligibleReimbursementsInput: '//*[@data-cy="steps-eligible-reimbursements-selector-switch"]//input',
    workFromHomeInput: '//*[@data-cy="steps-work-from-home-selector-switch"]//input',
    ...
    probationPeriodEnablement: '//*[@data-cy="steps-probation-period-selector-switch"]',
    probationPeriodInput: '//*[@data-cy="steps-probation-period-stepper-input"]',
    chooseprobationPeriodScaleButton: '//label[@data-cy="steps-probation-period-required-field-label"]/following::*[contains(@class,"control")][1]',
    ScaleSelect: "//*[contains(@id,'select') and contains(@id,'option') and text()='TYPE']",
    chooseNoticePeroidScaleButton: '//label[@data-cy="steps-termination-notice-period-required-field-label"]/following::*[contains(@class,"control")][1]',
    noticePeroidInput: '//*[@data-cy="steps-termination-notice-period-stepper-input"]',
    ...
    esopProvidedAcknowledgeCheck: '//*[@data-cy="steps-esop-provided-acknowledge-checkbox"]',
    salaryGrossSalaryInput: '//*[@data-cy="steps-salary-gross-salary-input"]',
    annualBonusEnablement: '//*[@data-cy="steps-annual-bonus-selector-switch"]//input',
    totalYearlyBonusInput: '//*[@data-cy="steps-total-yearly-bonus-input"]',
    bonusPayoutFrequencySelect: '//label[@data-cy="steps-bonus-payout-frequency-required-field-label"]/following::*[1]',
    frequencySelect: "//*[contains(@id,'select') and contains(@id,'option') and text()='FREQUENCY']",
